    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          template:
            "{% case nosuchthing %}{% when 'foo' %}foo{% when 'bar' %}bar{% endcase %}",
          want: "",
          context: {},
          partials: {},
          error: false,
        ...
        },
        {
          ...
          template:
            "{% case title %}{% when other %}{% if true %}foo{% endif %}{% when 'goodbye' %}bar{% endcase %}",
          want: "foo",
          context: {
            title: "Hello",
            other: "Hello",
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          template:
            "{% for item in (1..6) limit: 2 %}a{{ item }} {% endfor %}{% for item in (1..6) limit: 2 offset: continue %}b{{ item }} {% endfor %}{% for item in (1..6) offset: continue %}c{{ item }} {% endfor %}",
        ...
        },
        {
          ...
          template:
            "{% for item in (1..6) limit: 2 %}a{{ item }} {% endfor %}{% for item in (1..6) offset: continue %}b{{ item }} {% endfor %}{% for item in (1..6) offset: continue %}c{{ item }} {% endfor %}",
        ...
        },
        {
          ...
          template:
            "{% for item in array offset: continue %}{{ item }} {% endfor %}",
          want: "1 2 3 4 5 6 ",
          context: {
            array: [1, 2, 3, 4, 5, 6],
          },
      ...
      tests: [
        {
          ...
          template:
            "{% assign foo = 'hello' %}{% ifchanged %}{{ foo }}{% endifchanged %}{% ifchanged %}{{ foo }}{% endifchanged %}{% assign foo = 'goodbye' %}{% ifchanged %}{{ foo }}{% endifchanged %}",
          want: "hellogoodbye",
          context: {},
          partials: {},
          error: false,
        ...
        },
        {
          ...
          template:
            "{% assign foo = 'hello' %}{% ifchanged %}{{ foo }}{% endifchanged %}{% ifchanged %}{{ foo }}{% endifchanged %}",
          want: "hello",
          context: {},
          partials: {},
          error: false,
        ...
        },
        {
          ...
          template:
            '{% assign list = "1,3,2,1,3,1,2" | split: "," | sort %}{% for item in list -%}{%- ifchanged %} {{ item }}{% endifchanged -%}{%- endfor %}',
          want: " 1 2 3",
          context: {},
          partials: {},
          error: false,
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          template:
            "{% for tag in product.tags %}{% include 'tag' %}{% endfor %}",
          want: "SPORTS break!",
          context: {
            product: {
              tags: ["sports", "garden"],
        ...
        },
        {
          ...
          template:
            "{% increment foo %} {% include 'increment-outer-scope' %} {% increment foo %}",
          want: "0 1 2",
          context: {},
          partials: {
      ...
      tests: [
        {
          ...
          template:
            "{% assign foo = 5 %}{{ foo }} {% increment foo %} {% increment foo %} {{ foo }}",
          want: "5 0 1 5",
          context: {},
          partials: {},
          error: false,
        ...
        },
        {
          ...
          template:
            "{% increment foo %} {% increment bar %} {% increment foo %} {% increment bar %}",
          want: "0 0 1 1",
          context: {},
          partials: {},
          error: false,
        ...
        },
        {
          name: "named counter",
          template:
            "{% increment foo %} {% increment foo %} {% increment foo %}",
          want: "0 1 2",
          context: {},
          partials: {},
          error: false,
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          template:
            "{% liquid\rif product.title\r   echo product.title | upcase\relse\r   echo 'product-1' | upcase \rendif\r\rfor i in (0..5)\r   echo i\rendfor %}",
          want: "",
          context: {
            product: {
              title: "foo",
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          template:
            "{% for i in (1..3) %}{{ i }}{% render 'loop-scope' %}{{ i }}{% endfor %}{{ i }}",
          want: "112233",
          context: {},
          partials: {
            "loop-scope": "{{ i }}",
        ...
        },
        {
          ...
          template:
            "{% assign greeting = 'good morning' %}{{ greeting }} {% render 'outer-scope' %}{{ greeting }}",
        ...
        },
        {
          ...
          template:
            "{% for x in (1..3) %}{% render 'product' for collection.products %}{% endfor %}",
          ...
          partials: {
            product:
              "{{ product.title }}-{{ forloop.index0 }} {{ forloop.parentloop.index0 }}",
          },
          error: false,
          strict: false,
        },
        {
          ...
          partials: {
            product:
              "{{ product.title }}-{{ forloop.index0 }} {% for x in (1..3) %}{{ forloop.index0 }}{{ forloop.parentloop.index0 }} {% endfor %}",
          },
          error: false,
          strict: false,
        },
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          template:
            '{{ "Take my protein pills and put my helmet on" | replace: "my", nosuchthing }}',
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          name: "undefined second argument",
          template:
            '{{ "Take my protein pills and put my helmet on" | replace_first: "my", nosuchthing }}',
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          name: "array of objects",
          template:
            "{% assign x = a | sort: 'title' %}{% for obj in x %}{% for i in obj %}({{ i[0] }},{{ i[1] }}){% endfor %}{% endfor %}",
      ...
      tests: [
        {
          name: "argument is undefined",
          template:
            "{% assign x = a | sort_natural: nosuchthing %}{% for obj in x %}{% for i in obj %}({{ i[0] }},{{ i[1] }}){% endfor %}{% endfor %}",
        ...
        },
        {
          ...
          template:
            "{% assign x = a | sort_natural: 'title' %}{% for obj in x %}{% for i in obj %}({{ i[0] }},{{ i[1] }}){% endfor %}{% endfor %}",
          want: "(title,bar)(title,Baz)(title,foo)",
          context: {
            a: [
              {
        ...
        },
        {
          ...
          template:
            "{% assign x = a | sort_natural %}{% for i in x %}{{ i }}{% unless forloop.last %}#{% endunless %}{% endfor %}",
          want: "a#A#b#B#C#",
          context: {
            a: ["b", "a", null, "C", "B", "A"],
          },
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          name: "undefined first argument",
          template:
            '{{ "Ground control to Major Tom." | truncate: nosuchthing }}',
          want: "",
          context: {},
          partials: {},
          error: true,
        ...
        },
        {
          name: "undefined second argument",
          template:
            '{{ "Ground control to Major Tom." | truncate: 20, nosuchthing }}',
          want: "Ground control to Ma",
          context: {},
          partials: {},
          error: false,
      ...
      tests: [
        {
          name: "array of objects with key property",
          template:
            "{% assign x = a | uniq: 'title' %}{% for obj in x %}{% for i in obj %}({{ i[0] }},{{ i[1] }}){% endfor %}{% endfor %}",
          want: "(title,foo)(name,a)(title,bar)(name,c)",
          context: {
            a: [
              {
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          template:
            '{{ "email+address+is+bob%40example.com%21" | url_decode }}',
      ...
      tests: [
        {
          ...
          template:
            "{% assign x = a | where: 'title' %}{% for obj in x %}{% for i in obj %}({{ i[0] }},{{ i[1] }}){% endfor %}{% endfor %}",
        ...
        },
        {
          ...
          template:
            "{% assign x = a | where: 'title', 'bar' %}{% for obj in x %}{% for i in obj %}({{ i[0] }},{{ i[1] }}){% endfor %}{% endfor %}",
          want: "(title,bar)",
          context: {
            a: [
              {
