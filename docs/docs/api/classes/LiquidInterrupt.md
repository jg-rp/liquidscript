---
id: "LiquidInterrupt"
title: "Class: LiquidInterrupt"
sidebar_label: "LiquidInterrupt"
sidebar_position: 0
...
- `Error`
  ...
  ↳↳ [`BreakIteration`](BreakIteration.md)

  ↳↳ [`ContinueIteration`](ContinueIteration.md)

## Constructors

### constructor

• **new LiquidInterrupt**(`message`)
...
[src/errors.ts:381](https://github.com/jg-rp/liquidscript/blob/6bed77c/src/errors.ts#L381)
