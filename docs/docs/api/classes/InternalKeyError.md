---
id: "InternalKeyError"
title: "Class: InternalKeyError"
sidebar_label: "InternalKeyError"
sidebar_position: 0
...
- [`InternalLiquidError`](InternalLiquidError.md)
  ...
  ↳↳ [`LiquidKeyError`](LiquidKeyError.md)

## Constructors

### constructor

• **new InternalKeyError**(`message`)
...
[src/errors.ts:247](https://github.com/jg-rp/liquidscript/blob/6bed77c/src/errors.ts#L247)
