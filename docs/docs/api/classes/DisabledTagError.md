---
id: "DisabledTagError"
title: "Class: DisabledTagError"
sidebar_label: "DisabledTagError"
sidebar_position: 0
...
• **new DisabledTagError**(`message`, `token`, `templateName?`)
...
[src/errors.ts:206](https://github.com/jg-rp/liquidscript/blob/6bed77c/src/errors.ts#L206)
