---
id: "OrphanedBreakTagError"
title: "Class: OrphanedBreakTagError"
sidebar_label: "OrphanedBreakTagError"
sidebar_position: 0
...
• **new OrphanedBreakTagError**(`message`, `token`, `templateName?`)
...
[src/errors.ts:175](https://github.com/jg-rp/liquidscript/blob/6bed77c/src/errors.ts#L175)
