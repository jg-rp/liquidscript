---
id: "LiquidFilterValueError"
title: "Class: LiquidFilterValueError"
sidebar_label: "LiquidFilterValueError"
sidebar_position: 0
...
• **new LiquidFilterValueError**(`message`, `token`, `templateName?`)
...
[src/errors.ts:70](https://github.com/jg-rp/liquidscript/blob/6bed77c/src/errors.ts#L70)
