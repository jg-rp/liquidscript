---
id: "NoSuchFilterError"
title: "Class: NoSuchFilterError"
sidebar_label: "NoSuchFilterError"
sidebar_position: 0
...
• **new NoSuchFilterError**(`message`, `token`, `templateName?`)
...
[src/errors.ts:115](https://github.com/jg-rp/liquidscript/blob/6bed77c/src/errors.ts#L115)
