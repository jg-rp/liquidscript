---
id: "LiquidFilterArgumentError"
title: "Class: LiquidFilterArgumentError"
sidebar_label: "LiquidFilterArgumentError"
sidebar_position: 0
...
• **new LiquidFilterArgumentError**(`message`, `token`, `templateName?`)
...
[src/errors.ts:85](https://github.com/jg-rp/liquidscript/blob/6bed77c/src/errors.ts#L85)
