---
id: "LiquidTypeError"
title: "Class: LiquidTypeError"
sidebar_label: "LiquidTypeError"
sidebar_position: 0
...
• **new LiquidTypeError**(`message`, `token`, `templateName?`)
...
[src/errors.ts:54](https://github.com/jg-rp/liquidscript/blob/6bed77c/src/errors.ts#L54)
