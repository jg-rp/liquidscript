...
/**
 * Regular expression patterns for tokens in a Liquid argument list.
 */
export const RULES = [
...
/**
 * The compiled regular expression, built using {@link RULES}.
 */
...
function isAssignMatch(match: MatchGroups): match is AssignMatch {
  return match.TOKEN_ASSIGN === undefined ? false : true;
}
